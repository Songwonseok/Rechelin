                ...
                <div v-if="checkLogin">
                    ...
                    <div style="text-align: center !important;">
                        <v-btn
                            ...
                            id="find"
                            dark="dark"
                            style="position: relative; top: 250px; z-index:1;"
                    ...
                    <!-- 탭부분 -->
                    <v-tabs fixed-tabs="fixed-tabs" background-color="#ff7f00" dark="dark">
                        <v-tab router-link="router-link" :to="{name: 'user'}">
                            유저페이지
                        </v-tab>
                        <v-tab router-link="router-link" :to="{name: 'food'}">
                            음식점
                        </v-tab>
                        <v-tab router-link="router-link" :to="{name: 'review'}">
                            리뷰
                        </v-tab>
                        <v-tab>
                            피드 페이지(예정)
...
>>>>>>> 8899f90e0d251580051e3c2533d555513589d9b9
</template>

<script>
    import {mdiMagnify, mdiAccountCircle, mdiForum, mdiCrown, mdiPlus} from '@mdi/js'
