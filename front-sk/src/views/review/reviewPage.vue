            ...
            <b-modal style="text-align: center; margin-bottom: 10px;" id="bv-modal-example" hide-footer>
                    ...
                    <div class="d-block text-center">
                      ...
                      <h3>성별</h3>
                            ...
                            <span>체크 : {{gender}}</span>
                      <h3>분위기</h3>
                            <input type="checkbox" id="calm" value="조용한" v-model="atmosphere" v-on:click= "check_atmosphere()">
                            <label for="calm">조용한</label>
                            <input type="checkbox" id="comfortable" value="아늑한" v-model="atmosphere" v-on:click= "check_atmosphere()">
                            <label for="comfortable">아늑한</label>
                            <input type="checkbox" id="warm" value="따뜻한" v-model="atmosphere" v-on:click= "check_atmosphere()">
